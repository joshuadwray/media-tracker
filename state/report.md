# Media tracker report — 2026-08-14 23:31 UTC
...
- **Sunrise — Obreht, Téa**
  - reading: ebook in cloudLibrary catalog (Denton) — 1/1 available · Obreht , Téa
    ...
    - also: print book in denton library catalog — all 4 out, 3 holds
  ...
  - listening: audiobook in Libby catalog (Houston) — 0/1 available, 17 holds (~8 mo) · Téa Obreht
  - sync: gap 252d > 14d loan — suspend the reading hold ~252d for listening
...
- **Fruit Fly — Silver, Josh**
  ...
  - listening: audiobook in cloudLibrary catalog (Denton) — 0/1 available, 3 holds (~3 mo) · Silver, Josh, Watt, Will M, Mitchell, Fiona
    - also: audiobook in Libby catalog (Fort Worth) — 0/3 available, 33 holds (~5 mo)
...
- **big vegan flavor — nisha vora**
  - reading: ebook in Libby catalog (Houston) — 0/1 available, 14 holds (~7 mo) · Nisha Vora
