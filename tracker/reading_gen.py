...
.day { border: 1px solid var(--line); border-radius: 6px; min-height: 58px;
...
.thumbs img { width: 14px; aspect-ratio: 2 / 3; object-fit: cover;
       border-radius: 2px; }
.thumbs .dot { width: 14px; aspect-ratio: 2 / 3; border-radius: 2px;
       background: hsl(210,35%,40%); }
@media (min-width: 520px) { .day { min-height: 68px; font-size: .78rem; }
       .thumbs img, .thumbs .dot { width: 18px; } }
@media (min-width: 760px) { .day { min-height: 76px; } }
